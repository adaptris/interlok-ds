...
public abstract class JDBCStatementBuilderCase extends JdbcServiceCase
{
  ...
  private static final String AGE = Integer.toString(Period.between(LocalDate.parse(DOB, DateTimeFormatter.ISO_LOCAL_DATE), LocalDate.now()).getYears());
  ...
  protected static void createDatabase() throws Exception {
    ...
    try
    {
      ...
      s.execute("CREATE TABLE person " + "(id VARCHAR(128) NOT NULL, name VARCHAR(128) NOT NULL, dob DATE NOT NULL, age INT, inserted_on TIMESTAMP)");
    }
    finally
    {
